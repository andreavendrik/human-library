...
get_header(); ?>
	...
	<header class="header" style="background-image:url('<?php the_field( 'evenement_3_foto' ); ?>')"></div>
		<div class="header-title">
			<h2>Ontmoet je vooroordeel</h2>
			<h1>Ga in gesprek met <br>levende boeken</h1>
		</div>
	</header>
